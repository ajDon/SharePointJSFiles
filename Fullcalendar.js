	...
	{       
		...
		initailizeData: function(){
			var date = new Date(),
				filterJSON = {	$select : 'id,Title,EventDate,EndDate,Description,fAllDayEvent,fRecurrence,ParticipantsPicker/Id,Author/Id',
			...
			JCIAPAC.execute('getDefaultFormUrl','APAC Events',"DefaultDisplayFormUrl")
			...
			JCIAPAC.execute("getListDataByFilter",'APAC Events',filterJSON,false)
							.success(function (data) {
